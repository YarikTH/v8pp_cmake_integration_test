...
set(V8PP_SOURCE_DIR "${CMAKE_CURRENT_LIST_DIR}/../v8pp")
...
function(install_v8pp_locally WORK_DIR)
    set(V8PP_SOURCE_DIR "${V8PP_SOURCE_DIR}")
    set(V8PP_BUILD_DIR "${WORK_DIR}/v8pp/build")
    set(V8PP_INSTALL_DIR "${WORK_DIR}/v8pp/install")

    file(MAKE_DIRECTORY ${V8PP_BUILD_DIR})

    execute_process_checked("v8pp CMake configuration"
                             COMMAND ${CMAKE_COMMAND}
                                     -DV8PP_TEST=n
                                     -DCMAKE_INSTALL_PREFIX=${V8PP_INSTALL_DIR}
                                     ${V8PP_SOURCE_DIR}
                             WORKING_DIRECTORY ${V8PP_BUILD_DIR}
    )

    execute_process_checked("v8pp CMake build"
                             COMMAND ${CMAKE_COMMAND} --build . --target install
                             WORKING_DIRECTORY ${V8PP_BUILD_DIR}
    )
endfunction()

check_cmake_integration(cmake_find_package SOURCE_DIR cmake_find_package BEFORE install_v8pp_locally PREFIX_PATH v8pp/install)
